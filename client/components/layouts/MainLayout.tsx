    ...
    <div className="min-h-screen bg-gradient-to-b from-veda-sky/20 via-background to-background text-foreground">
      <header className="sticky top-0 z-40 backdrop-blur supports-[backdrop-filter]:bg-background/70 border-b">
        <div className="container flex items-center justify-between py-3">
          <Link
            to="/"
            className="flex items-center gap-2 font-extrabold text-xl text-veda-sky"
          >
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              to="/#get-started"
              className="rounded-2xl bg-veda-yellow text-veda-primary-ink px-4 py-2 font-semibold shadow-soft hover:shadow-soft-lg transition-all active:scale-95"
            >
              Get Started
            </Link>
          </div>
      ...
      <footer className="border-t mt-16">
        <div className="container py-8 text-sm text-muted-foreground flex flex-col md:flex-row items-center justify-between gap-4">
          <p>
            © {new Date().getFullYear()} Veda — Adaptive Learning for Everyone
          </p>
